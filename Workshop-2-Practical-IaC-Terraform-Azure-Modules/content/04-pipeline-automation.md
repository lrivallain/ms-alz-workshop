...
$servicePrincipal = az ad sp create-for-rbac --name "sp-terraform-pipeline" --role "Contributor" --scopes "/subscriptions/<subscription-id>" --sdk-auth
...
4. Enter the service principal details
5. Name: `azure-terraform-service-connection`
